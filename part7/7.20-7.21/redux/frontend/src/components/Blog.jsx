...
const Blog = () => {
  ...
  return (
    <div>
      ...
      <Typography variant="body1">{blog.likes} likes<Button variant="outlined" onClick={handleLike}>like</Button></Typography>
      <Typography variant="h3">comments</Typography>
      <form onSubmit={handleComment}>
        <TextField name="comment" /><Button variant="contained" type="submit">add comment</Button>
      </form>

...
describe("<Blog />", () => {
  beforeEach(() => {
    ...
    const user = {
      ...
      username: "username",
      token:
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImhlbGxvMSIsImlkIjoiNjhkYWFhMjk1N2Y2NmY4MWU2ZTNkZjc5IiwiaWF0IjoxNzU5NTIyOTYzfQ.fbnf80xJCCBJdS3N8JDtNE-9bqtl0QofGW-IUG8-1xU",
    };
